-- NovaLibrary v2.0 - Skonsolidowany Skrypt (Loadstring Version)
-- Wersja 2.0 - Pełna rozbudowa: Tabs, Sections, Notifications, Sliders, Dropdowns, TextBox, Search, Config, Tooltips
--
-- Aby użyć, skopiuj i wklej do swojego executora:
-- local NovaLibrary = loadstring(game:HttpGet("https://raw.githubusercontent.com/DizzyUSER69/NovaLibrary/main/NovaLibrary_v2.lua"))()
--
-- Ten skrypt zawiera wszystkie moduły NovaLibrary v2.0 (Core, Components, Advanced) w jednym pliku.
